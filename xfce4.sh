...
xfce4_panel_0_plugin_names=("launcher_1" "launcher_2" "launcher_3" "appmenu" "clock" "weather" "systemload" "separator" "notification-plugin" "thunar-tpa" "systray" "indicator" "statusnotifier" "pulseaudio" "power-manager-plugin")
